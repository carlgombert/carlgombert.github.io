    ...
    <nav className="h-14 flex items-center justify-between px-5 bezel-frame shrink-0 rounded-t-2xl relative">
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex flex-col">
          <span className="font-display text-[0.65rem] text-aero-text tracking-[0.2em]">
            CARL GOMBERT
          </span>
          <span className="font-mono text-[0.4rem]">PORTFOLIO</span>
        </div>
      </div>
        ...
        {sections.map((s, i) => {
          ...
          return (
            <Link
              ...
              to={path}
              className={`
                font-mono text-[0.45rem] px-2.5 py-1 rounded-full border-2 transition-all cursor-pointer no-underline
                ${i === activeIndex
